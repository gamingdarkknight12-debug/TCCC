    ...
    <header className="sticky top-0 z-50 border-b border-emerald-900/10 bg-white/90 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
        ...
        <nav className="hidden items-center gap-2 md:flex">
          ...
          <div className="ml-2 flex items-center gap-1 rounded-full border border-emerald-900/10 bg-white p-1 shadow-sm">
            <a
              href="/"
              className="rounded-full px-4 py-2 text-sm font-black text-slate-700 transition hover:bg-slate-100"
            >
              TT
            </a>
      ...
      {/* Mobile Menu + Team Switcher */}
      <div className="border-t border-emerald-900/10 px-4 pb-3 md:hidden">
        ...
        <div className="mx-auto mt-3 flex w-fit items-center gap-1 rounded-full border border-emerald-900/10 bg-white p-1 shadow-sm">
          <a
            href="/"
            className="rounded-full px-4 py-2 text-sm font-black text-slate-700 transition hover:bg-slate-100"
          >
